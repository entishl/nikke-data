...
export const getUnions = () => {
  return apiClient.get('/api/unions/');
};

export const addUnion = (unionName) => {
  return apiClient.post('/api/unions/', { name: unionName });
};
...
export const updateUnion = (id, unionName) => {
  ...
  return apiClient.put(`/api/unions/${id}`, { name: unionName });
};

export const deleteUnion = (id) => {
  return apiClient.delete(`/api/unions/${id}`);
};
